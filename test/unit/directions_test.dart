...
void main() {
  ...
  group("DirectionsResult", () {
    ...
    test("fromJson with complete json", () {
      ...
      expect(dr.route.originAddress, equals("Rua Presbiteriana, 151"));
      expect(
          dr.route.destinationAddress, equals("Avenida Olegario Maciel, 120"));
      expect(dr.route.originLatitude, equals(-16.111111));
      expect(dr.route.originLongitude, equals(46.111111));
      expect(dr.route.destinationLatitude, equals(-17.111111));
      expect(dr.route.destinationLongitude, equals(47.111111));
  ...
  group("Route", () {
    ...
    test("fromJson with empty json", () {
      ...
      expect(r.originAddress, isNull);
      expect(r.destinationAddress, isNull);
    ...
    test("fromJson with complete json", () {
      ...
      expect(r.originAddress, equals("Rua Presbiteriana, 151"));
      expect(r.destinationAddress, equals("Avenida Olegario Maciel, 120"));
      expect(r.encodedPoints, equals("arandombunchofpoints"));
      expect(r.originLatitude, equals(-16.111111));
      expect(r.originLongitude, equals(46.111111));
      expect(r.destinationLatitude, equals(-17.111111));
      expect(r.destinationLongitude, equals(47.111111));
    });
  });
  ...
  group("Leg", () {
    ...
    test("fromJson with empty json", () {
      ...
      expect(l.originAddress, isNull);
      expect(l.destinationAddress, isNull);
    });
    ...
    test("fromJson with complete json", () {
      ...
      expect(l.originAddress, equals("Rua Presbiteriana, 151"));
      expect(l.destinationAddress, equals("Avenida Olegario Maciel, 120"));
      expect(l.originLatitude, equals(-16.111111));
      expect(l.originLongitude, equals(46.111111));
      expect(l.destinationLatitude, equals(-17.111111));
      expect(l.destinationLongitude, equals(47.111111));
    });
  });
